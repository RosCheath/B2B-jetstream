        ...
        <div class="row align-items-center py-3 px-xl-5">
            ...
            <div class="col-lg-3 col-6 text-right">
                <button type="button"
                        ...
                        aria-controls="drawer-right-example" class="btn border">
                    <i class="fas fa-heart text-primary"></i>
                    <span class="badge">1</span>
                </button>

                <!-- Fav drawer component -->
                <div id="drawer-right-example" class="fixed z-40 h-screen p-4 overflow-y-auto bg-white w-80 dark:bg-gray-800 transition-transform right-0 top-0 transform-none" tabindex="-1" aria-labelledby="drawer-right-label" aria-modal="true" role="dialog">
                    <h5 id="drawer-right-label" class="inline-flex items-center mb-4 text-base font-semibold text-gray-500 dark:text-gray-400"></h5>
...
{{--                    </div>--}}
                ...
                <button type="button"
                   data-drawer-target="drawer-right-add_to_card"
                   data-drawer-show="drawer-right-add_to_card"
                   data-drawer-placement="right"
                   aria-controls="drawer-right-add_to_card" class="btn border">
                    <i class="fas fa-shopping-cart text-primary"></i>
                    <span class="badge">0</span>
                </button>

                <!-- add to card drawer component -->
                <div id="drawer-right-add_to_card" class="fixed z-40 h-screen p-4 overflow-y-auto bg-white w-80 dark:bg-gray-800 transition-transform right-0 top-0 transform-none" tabindex="-1" aria-labelledby="drawer-right-label" aria-modal="true" role="dialog">
